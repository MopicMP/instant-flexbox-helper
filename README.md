# instant-flexbox-helper

> Instant flexbox layout utility classes

[![npm version](https://badge.fury.io/js/instant-flexbox-helper.svg)](https://www.npmjs.com/package/instant-flexbox-helper)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

## Installation

```bash
npm install instant-flexbox-helper
```
...
```javascript
const { helper, batch } = require('instant-flexbox-helper');
